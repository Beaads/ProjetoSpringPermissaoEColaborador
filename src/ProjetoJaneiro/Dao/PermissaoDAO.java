...
public class PermissaoDAO {
   private final Connection connection;
    ...
    public PermissaoDAO(Connection connection) { this.connection = connection; }

    public void cadastrarPermissao(Permissao permissao) {
        try (Connection connection = new ConnectionFactory().recuperarConexao()) {
            PreparedStatement stm = connection.prepareStatement("INSERT INTO PERMISSAO (CODIGOPERMISSAO, NOMEPERMISSAO ) VALUES (?, ?)");
